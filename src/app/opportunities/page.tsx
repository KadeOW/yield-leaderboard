...
const OPPORTUNITIES: Opportunity[] = [
  ...
  },
  {
    ...
    protocol: 'Aave V3',
    chain: 'Sepolia',
    asset: 'USDC, WETH, DAI, USDT',
    type: 'lending',
    apyMin: 2,
    apyMax: 12,
    tvlNote: 'Battle-tested protocol',
    risk: 'low',
    description: 'The leading DeFi lending protocol. Supply assets to earn interest, or use as collateral. On Sepolia for development.',
    url: 'https://app.aave.com',
    logoEmoji: '👻',
    color: 'border-purple-500/30 bg-purple-500/5',
    tags: ['Battle-tested', 'Multi-asset', 'Lending'],
  },
  {
    id: 'lido-eth',
    protocol: 'Lido',
    ...
    apyMin: 3,
    apyMax: 4.5,
    tvlNote: 'Largest liquid staking',
    risk: 'low',
    description: 'Liquid ETH staking. Stake ETH and receive stETH which accrues daily staking rewards. No minimum, fully liquid.',
    url: 'https://lido.fi',
    logoEmoji: '🔷',
    color: 'border-blue-500/30 bg-blue-500/5',
    tags: ['Liquid staking', 'ETH native', 'Low risk'],
  },
  {
    id: 'morpho-blue',
    protocol: 'Morpho',
    ...
    apyMin: 5,
    apyMax: 15,
    tvlNote: 'Optimized lending',
    risk: 'low',
    description: 'Peer-to-peer lending built on Aave and Compound. Higher supply rates and lower borrow rates through direct matching.',
    url: 'https://app.morpho.org',
    logoEmoji: '🔵',
    color: 'border-blue-400/30 bg-blue-400/5',
    tags: ['P2P lending', 'High rates', 'Curated vaults'],
  },
];
